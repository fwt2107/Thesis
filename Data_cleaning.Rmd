...
2. I changed the variable names for the age-adjusted rate 95% CI and 
...
# Covariates
Covariates for this analysis are: race/ethnicity, gender, urban/ruralness, 
educational attainment, and absolute income level.
...
1. Keep only the county code, state, county name, and urban/rural classification
...
3. Separate state name from county name
```{r}
...
data. Studies and vital stats have indicated that whites have higher 
age-adjusted rates of suicide compared to other racial/ethnic groups, and males
have greater age-adjusted rates of suicide compared to females.
...
gender_race_df <- read_csv('./Raw data/ACS 2012-2016 Demographics.csv') %>% 
  ...
  select(county_code = geo_id2,
         ...
         white_prop = hc03_vc49,
         white_prop_moe = hc04_vc49) 
