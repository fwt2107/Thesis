...
```{r}
final_df <- inner_join(acs_exp_df, cdc_df, by = "county_code") %>% 
  inner_join(., acs_income_df, by = "county_code") %>% 
  inner_join(., nchs_df, by = "county_code") %>% 
  inner_join(., edu_df, by = "county_code") %>% 
  inner_join(., socialcap_df, by = "county_code") %>% 
  inner_join(., gender_race_df, by = "county_code")
```
